    ...
    <div className="max-w-4xl mx-auto px-8">
      ...
      <div className="mb-12">
        ...
        <p className="max-w-2xl mt-6">
          A collection of various artworks exploring different techniques, mediums, and conceptual approaches. This diverse body of work represents experimental pieces, and explorations outside of the main series.
        </p>
      </div>
